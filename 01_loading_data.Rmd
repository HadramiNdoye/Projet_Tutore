...
**L’expression par un modèle linéaire intégrant toutes les sondes : expr ~ meth_1 + meth_2 + … + meth11 pour le gène AKR1E2**
```{r}
# linear model
...
**Récuperation des données omics du gene SGCE et PEG10**
```{r}
...
**Pour le gène SGCE, régression linéaire, contruction et exportation d'un fichier.bed correspondant aux 90 p-valeurs des 90 sondes**
```{r}
