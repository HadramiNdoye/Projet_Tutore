...
plot(-log10(pval.ewas),col="red",pch=19,xaxt="n", xlab = "", main = "SGCE, p-valeurs SLK et FDR vs p-valeurs de la regression", ylim=c(0, max(-log10(pval.slk), -log10(pval.ewas))))
...
# Ajouter une légende
legend("topright", legend=c("pvalues lm", "pvalues comb-p (slk)", "pvalues comb-p (fdr)",  "threshold", "region"), col = c("red","blue", "purple", "black", "green"),pch= c(19,18,18), lwd=c(0,0,0,1,2), lty = c(1,1,1,2,1))
```
...
plot(-log10(pval.ewas),col="red",pch=19,xaxt="n", xlab = "", main = "PEG10, p-valeurs SLK et FDR vs p-valeurs de la regression", ylim=c(0, max(-log10(pval.slk), -log10(pval.ewas))))
axis(1,at=x,labels = rownames(meth.sgce),las=2, cex.axis = 0.5, cex.axis = 0.5)
lines(x1,y1,type="o",col="green",pch=18)
points(-log10(pval.slk),col="blue",pch=18)
points(-log10(pval.fdr),col="purple",pch=18)
...
### plot 
x <- 1:dim(meth)[1]
plot(x,-log10(pval1),col="grey", xaxt="n", xlab = "", lwd = 5, pch=20, type = 'l', main="p-valeur de fisher multiple  SGCE + PEG10")
